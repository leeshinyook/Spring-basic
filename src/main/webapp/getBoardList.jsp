...
<tr>
	<td align="right">
		...
		<option value="TITLE"><spring:message code="message.board.list.table.condition.title"/>
		<option value="CONTENT"><spring:message code="message.board.list.table.condition.content"/>
		</select>
		<input name="searchKeyword" type="text"/>
		<input type="submit" value="<spring:message code="message.board.list.condition.condition.btn"/>"/>
	</td>
</tr>
</table>
</form>
